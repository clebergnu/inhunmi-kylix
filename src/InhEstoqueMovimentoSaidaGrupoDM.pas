unit InhEstoqueMovimentoSaidaGrupoDM;
...
type
  TEstoqueMovimentoSaidaGrupoDM = class(TDataModule)
...
var
  EstoqueMovimentoSaidaGrupoDM: TEstoqueMovimentoSaidaGrupoDM;
...
{ TEstoqueMovimentoSaidaGrupoDM }

function TEstoqueMovimentoSaidaGrupoDM.DMOpen: boolean;
begin
...
procedure TEstoqueMovimentoSaidaGrupoDM.MovimentoGrupoDSetAfterPost(
  DataSet: TDataSet);
var
...
procedure TEstoqueMovimentoSaidaGrupoDM.MovimentosDSetBeforePost(
  DataSet: TDataSet);
var
...
procedure TEstoqueMovimentoSaidaGrupoDM.MovimentosDSetAfterPost(
  DataSet: TDataSet);
begin
...
procedure TEstoqueMovimentoSaidaGrupoDM.MovimentoGrupoDSetBeforeDelete(
  DataSet: TDataSet);
begin
...
procedure TEstoqueMovimentoSaidaGrupoDM.MovimentosUpdateDepartamentoDataHora;
var
   Query : TSQLDataSet;
begin
